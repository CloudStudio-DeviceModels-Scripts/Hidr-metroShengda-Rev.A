...
# Configuration Script – Hidrómetro Shengda - Rev. A

This **Configuration** script is designed for the **Hidrómetro Shengda** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – Hidrómetro Shengda Rev. A

Este script de **Configuration** está diseñado para el modelo **Hidrómetro Shengda** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
